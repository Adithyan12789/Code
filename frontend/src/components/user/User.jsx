...
import { Eye, Check, User as UserIcon } from "lucide-react";
...
const User = (props) => {
  ...
  const { realUserData, totalRealUser } = useSelector((state) => state.user);
  ...
  const handleEdit = (row, type) => {
    ...
    navigate(`/viewProfile?id=${row?._id}`);
      ...
      Cell: ({ row }) => (
        ...
        >
          ...
          <div className="ml-3 flex items-center space-x-2">
            ...
            {row?.isVerified == true && (
              <img src={Verified.src} alt="Verified" className="w-5 h-5" />
            )}
          </div>
        </div>
      ),
        ...
        <div className="flex items-center space-x-2">
          ...
          <span
            className={`text-sm font-medium ${
              row?.isBlock ? "text-red-600" : "text-green-600"
            }`}
          >
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div className="mb-4 sm:mb-0">
              ...
              <p className="text-sm text-gray-600 mt-1">
                Manage real users in the system
              </p>
            </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm font-medium text-blue-800">
                  {selectCheckData.length} user(s) selected
                </span>
              </div>
              <div className="flex items-center space-x-2">
                <button
